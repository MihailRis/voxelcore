...
| Название     | Тип    | Чтение | Запись | Описание                                                               |
|--------------|--------|--------|--------|------------------------------------------------------------------------|
| value        | float  | да     | да     | текущее значение                                                       |
| min          | float  | да     | да     | минимальное значение                                                   |
| max          | float  | да     | да     | максимальное значение                                                  |
| progress     | float  | да     | нет    | прогресс 0..1                                                          |
| displayValue | float  | да     | нет    | отображаемое (анимированное) значение                                  |
| color        | rgba   | да     | да     | цвет заполненной части                                                 |
| bgColor      | rgba   | да     | да     | цвет фона (пустой части)                                               |
| textColor    | rgba   | да     | да     | цвет текста                                                            |
| text         | string | да     | да     | текст по центру бара                                                   |
| smooth       | bool   | да     | да     | плавное изменение значения                                             |
| smoothSpeed  | number | да     | да     | скорость плавного перехода в единицах в секунду                        |
| orientation  | string | да     | да     | направление заполнения: "horizontal" / "vertical"                      |
